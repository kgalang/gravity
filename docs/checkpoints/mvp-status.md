...
- Replace placeholder channel IDs in `seed.sql` with real Slack channel IDs before CP3 runtime testing.
- Define CP3 implementation slices (Slack event ingestion, agent routing, and outbound posting) in a new active plan.
